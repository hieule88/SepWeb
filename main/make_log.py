...
parser.add_argument('--folder_dataset', type=str, required=True, default="/content/drive/MyDrive/SpeechSeparation/dataset")
parser.add_argument('--log_path_train', type=str, required=True, default="/content/drive/MyDrive/SpeechSeparation/dataset/mix_2_spk_tr.txt")
parser.add_argument('--log_path_valid', type=str, required=True, default="/content/drive/MyDrive/SpeechSeparation/dataset/mix_2_spk_vd.txt")
...
if __name__ == "__main__":
    ...
    for type_ in type_folder:
        ...
        for spk_name in tqdm(spk_folders, total= num_spk):
